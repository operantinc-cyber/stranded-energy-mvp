        ...
        <div className="flex flex-col gap-4 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">
              Internal Development Desk
            </h1>
            <p className="mt-2 max-w-2xl text-sm text-zinc-600">
              Track early-stage energy opportunities and maintain the input data needed for screening, sizing, risk review, monetization, and memo generation.
            </p>
          </div>
